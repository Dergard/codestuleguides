...
```
Так как  `end` это завершающая конструкция для многих случаев читающему код поможет использование комментирование того, что `end` завершает
```lua
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI2MTY2MTU2LDUxNjM2NTU1NywxNzY3OD
