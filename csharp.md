...
- Множественное число следует использовать в случае, если пространство имен объединяет некоторое количество разных, но семантически похожих сущностей. И наоборот, когда
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjA5NTE2MjA1XX0=
-->